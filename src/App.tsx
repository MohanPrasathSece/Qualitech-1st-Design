      ...
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 font-display text-lg font-bold text-background">
              Precision Connections.<br />Engineered for Performance.
            </p>
            <div className="mt-6 space-y-1.5 text-sm text-steel">
              <p>LIG B-279, Dr. A S Rao Nagar,</p>
              <p>ECIL Post, Hyderabad – 500 062</p>
              <p className="mt-4">
                <a href="tel:+914027140004" className="transition-colors hover:text-background">+91-40-27140004</a>
              </p>
              <p>
                <span className="text-steel/60">+91-40-27140005 (Fax)</span>
              </p>
              <p className="mt-2">
                <a href="mailto:info@qualitechindia.in" className="transition-colors hover:text-background">info@qualitechindia.in</a>
              </p>
            </div>
          </div>
              ...
              {FOOTER_COMPANY.map((item) => (
                <li key={item.label}>
                  <button
                    ...
                    className="text-sm text-steel transition-colors duration-300 hover:text-background cursor-pointer text-left"
                  >
                    {item.label}
                  </button>
                </li>
          ...
          <div>
            ...
            <div className="mt-8 border-t border-background/10 pt-6">
              <p className="text-sm font-medium text-steel">Need a custom cable solution?</p>
              <button
                onClick={() => (onNavigate ? onNavigate("#contact") : undefined)}
                className="mt-3 inline-flex font-display text-[0.72rem] font-bold uppercase tracking-[0.18em] text-brand-blue-soft transition-colors duration-300 hover:text-background cursor-pointer text-left"
              >
                Request a Quote →
              </button>
            </div>
