...
export const PRODUCTS: Product[] = [
  ...
  // ═══════════════════════════════════════════
  {
    ...
    sku: "ZOLEX-COMP-01",
    name: "Zolex Electronics Components",
    category: "Electronics Components",
  ...
  },
  {
    ...
    sku: "ZOLEX-COMP-02",
    name: "Zolex Industrial Connectors",
    category: "Electronics Components",
    subCategory: "Zolex — Components",
    brand: "Zolex",
    description: "Zolex industrial connectors for factory automation, sensor interfaces and control systems. Distributed by Qualitech Connectronics.",
    features: [
  ...
  },
  {
    ...
    sku: "ZOLEX-COMP-03",
    name: "Zolex PCB Interconnects & Headers",
    category: "Electronics Components",
    subCategory: "Zolex — Components",
    brand: "Zolex",
    description: "Zolex PCB-level interconnects, headers and terminal interfaces for electronic assemblies. Distributed by Qualitech Connectronics.",
    features: [
